package Dashboard;
import PortfolioFrame.UserData;
...
public class LoginFrame extends JFrame {
	private ImageIcon photoboothBG = new ImageIcon(
			new ImageIcon("C:\\Users\\Windows 10\\OneDrive - National University\\OOPproject\\Blissful Shots\\New folder\\blissful shots logo.png")
					.getImage().getScaledInstance(420, 564, Image.SCALE_DEFAULT));
	...
	static {
		UserData login = new UserData("Miguel", "Polison", "1234567890", "20", "admin1@example.com", "password1", "Male");
		UserData login2 = new UserData("Raine", "Briones", "1234567890", "19", "admin2@example.com", "password2", "Female");
		UserData login3 = new UserData("Nicole", "nocumm", "1234567890", "28", "admin3@example.com", "password3", "Female");
		loginList.add(login);
	...
	public LoginFrame() {
	    ...
	    setBounds(100, 100, 882, 572);
	    setLocationRelativeTo(null);
		setUndecorated(true);
	    contentPane = new JPanel();
	    contentPane.setBounds(100, 100, 900, 572);
	    setContentPane(contentPane);
	    contentPane.setLayout(null);

	    JPanel RegisterPanel = new JPanel();
	    RegisterPanel.setBounds(406, 0, 476, 575);
	    ...
	    Caption3_1_1_2.setBounds(73, 457, 272, 24);
	    RegisterFormPanel.add(Caption3_1_1_2);
	    
	    JRadioButton maleButton = new JRadioButton("Male");
	    maleButton.setBounds(156, 458, 109, 23);
	    RegisterFormPanel.add(maleButton);
	    
	    JRadioButton femaleButton = new JRadioButton("Female");
	    femaleButton.setBounds(284, 458, 109, 23);
	    ...
	    registerButton.setBounds(203, 492, 63, 23);
	    RegisterFormPanel.add(registerButton);
	    
	    JPanel emailPanel = new JPanel();
	    emailPanel.setLayout(null);
	    emailPanel.setBackground(Color.WHITE);
	    emailPanel.setBounds(71, 164, 320, 40);
	    LoginPanel.add(emailPanel);
	    
	    emailladdressField1 = new JTextField();
	    emailladdressField1.setText("Username / Email");
	    emailladdressField1.addFocusListener(new FocusAdapter() {
			...
			@Override
			public void focusGained(FocusEvent e) {
				if (emailladdressField1.getText().equals("Username / Email")) {
	    ...
	    passwordPanel_1.setBounds(71, 215, 320, 40);
	    ...
	    passwordPanel_1.add(iconOfLock_1);
	 ...
	 // create a JButton with the label "Login" and add an ActionListener to handle events
	    ...
	    JPanel PhobotoBGpanel = new JPanel();
	    PhobotoBGpanel.setBackground(new Color(255, 255, 255));
		PhobotoBGpanel.setBounds(0, -11, 407, 598);
		contentPane.add(PhobotoBGpanel);
		PhobotoBGpanel.setLayout(null);
		
		JLabel photobgLbl = new JLabel("");
		photobgLbl.setIcon(photoboothBG);
		photobgLbl.setBounds(0, 11, 407, 629);
		PhobotoBGpanel.add(photobgLbl);
		
		JLabel exitIcon = new JLabel();
		PhobotoBGpanel.add(exitIcon);
		exitIcon.setIcon(xIcon);
		exitIcon.addMouseListener(new MouseAdapter(){
			...
			public void mouseEntered(MouseEvent args0) {
				exitIcon.setForeground(Color.RED);
			}
			@Override
