...
public class Dedication extends JFrame {

	private JPanel contentPane;
	private ImageIcon twinstrippicture = new ImageIcon(
			new ImageIcon( "C:\\Users\\Windows 10\\eclipse-workspace\\BlissfulShotPhotoBooth\\SourceImage\\packagepanelImga\\dedication - 10.jpg")
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Dedication frame = new Dedication();
	...
	public Dedication() {
		...
		Twinpanel.setBackground(new Color(255, 253, 201));
		...
		JLabel pricelbl = new JLabel("3000");
